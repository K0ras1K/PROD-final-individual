...
class EditAdventureDescriptionHandler(private val callbackQuery: CallbackQuery, private val bot: Bot) {
    fun handle() {
        runBlocking {
            ...
            StatusMachine.setStatus(
                chatId,
                StatusData(
                    status = TextStatus.ADVENTURE_DESCRIPTION,
            ...
            bot.editMessageText(
                ...
                text = "Введите описание путешествия",
            )
        }
    }
}
