...
Ссылка на бота [здесь](https://t.me/ttagent_kk0ras1kk_bot)
...
Для ускоренной генерации маршрутов API Graphhopper с базой OpenStreetMaps. Этот сервис предоставляет удобный, оптимизированный и быстрый алгоритм прокладывания маршрутов. Сервис был выбран из-за его высокой скорости и доступности.
